...
using Celestium.Content.Items.Weapons.Ranged;

namespace Celestium.Content.Items.Weapons.Melee
{
	public class Hellbladeshark : ModItem
	{

		public override void SetStaticDefaults() {
			Tooltip.SetDefault("INSANELY awesome.");
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<Bladeshark>());

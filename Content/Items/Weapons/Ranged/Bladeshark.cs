...
{
	public class Bladeshark : ModItem
	{

		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Even more completely awesome.");
		...
		public override void AddRecipes() {
			...
			.AddIngredient(ModContent.ItemType<KcirbiteBar>(), 3)
            .AddIngredient(ModContent.ItemType<HyperiusBar>(), 2)
